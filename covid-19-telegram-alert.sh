...
COUNTRY="INDONESIA" # Example: Indonesia (Worldometers format)
...
function sendTelegram() {
	...
	curl -s "https://api.telegram.org/bot${1761207012:AAEClxbLuR38_dcZtsGs3tk7wKAmqiIwe5E}/sendMessage?chat_id=${@ambisptnID_bot}&parse_mode=Markdown&text=${urldata}"
}
